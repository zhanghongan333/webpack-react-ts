...
import { collapseData, getLeftRelation, getRightRelation, transformData } from '../../utils/common'
import {
  clearAllStats,
  handleAutoZoom,
  handleDownloadImage,
...
const LineageGraph = ({
   ...
   * 处理节点点击事件
   */
  const handleNodeClick = (graph: any, item: any, currentAnchor: string, name: string) => {
    ...
    // 设置左关联边及节点状态
    setLeftStats(graph, leftActiveEdges, currentHighlightColorRef.current, name)

    // 设置右关联边及节点状态
    setRightStats(graph, rightActiveEdges, currentHighlightColorRef.current, name)
  }
